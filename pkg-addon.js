...
fs.copyFileSync(path.resolve(__dirname, 'dist/geocoding-sheet.css'), path.resolve(__dirname, 'gcp/geocoding-sheet.css'))
fs.copyFileSync(path.resolve(__dirname, 'dist/geocoding-sheet.js'), path.resolve(__dirname, 'gcp/geocoding-sheet.js'))
fs.copyFileSync(path.resolve(__dirname, 'dist/polyfill.js'), path.resolve(__dirname, 'gcp/polyfill.js'))
